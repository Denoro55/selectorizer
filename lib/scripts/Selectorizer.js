...
var Selectorizer = /** @class */ (function () {
    ...
    Selectorizer.prototype.initListeners = function () {
        ...
        (_a = this.elements.$dropdown) === null || _a === void 0 ? void 0 : _a.addEventListener("click", function (e) {
            if (!(e.target instanceof HTMLElement)) {
                return;
            }
            var $dropdownItem = helpers_1.getClosestElement(e.target, const_1.CLASSES.dropdownItem);
            if ($dropdownItem) {
                var dataIndex = $dropdownItem.getAttribute("index");
                var index = dataIndex ? +dataIndex : null;
                if (index !== null) {
                    _this.change(_this.state.options[index].value);
                }
            }
        });
